...
public class Main extends Application {
	...
	*/
	...
	public void updateConsoleTaskLists(ArrayList<String> newConsoleList,ArrayList<String> newTaskList){
	...
	public void addToConsoleList(String consoleString){
		_consoleList.add(consoleString);
	}
	
//	public void setConsoleList(ArrayList<String> newConsoleList){
//		_consoleList = newConsoleList;
//	}
//	
//	public void setTaskList(ArrayList<String> newTaskList){
//		_taskList = newTaskList;
//	}
//	
	public void setHelpList(ArrayList<String> newHelpList){
